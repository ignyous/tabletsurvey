    ...
    <form novalidate class="form" role="form" autocomplete="off" name="NewRecordForm" action="interview.php" method="post">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="form-group">
          	<label for="releaseofDrugAgreement" class="required">I agree to the release of information pertaining to drug and alcohol abuse diagnosis or treatment. *</label>
            <div class="radio">
            <label>
            <input type="radio" name="releaseofDrugAgreement" value="Yes" checked>
            Yes         
            </label>
            </div>
            <div class="radio">
            <label>
            <input type="radio" name="releaseofDrugAgreement"  value="No">
            No
            </label>
            </div>            
          </div>
          ...
          <div class="form-group">
          	<label for="hiv" class="required">I agree to the release of HIV/AIDS diagnosis. *</label>
            <div class="radio">
            <label>
            <input type="radio" name="hiv" value="Yes" checked>
            Yes         
            </label>
            </div>
            <div class="radio">
          ...
          <div class="form-group">
          	<label for="releaseofMentalAgreement" class="required">I agree to the release of information pertaining to mental health diagnosis or treatment. *</label>
            <div class="radio">
            <label>
            <input type="radio" name="releaseofMentalAgreement" value="Yes" checked>
            Yes         
            </label>
            </div>
            <div class="radio">
            <label>
            <input type="radio" name="releaseofMentalAgreement"  value="No">
            No
            </label>
            </div>            
          </div>
         ...
         <div class="clearboth"></div>
            ...
            <div class="form-group">
            <label for="witnessName" class="required">Witness Name *</label>
            <select class="form-control" id="witnessName" name="witnessName" required>
            ...
            <div class="form-group">
            <label for="signature" class="required">Witness Signature *</label>
