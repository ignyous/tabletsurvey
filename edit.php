...
<title>View/Edit Existing Record</title>
...
<div id="content">
  <div class="container">
    <form novalidate class="form-horizontal" role="form" autocomplete="off" name="NewRecordForm" action="edit.php" method="post">
      <div class="row">
        <div class="col-md-12">
          <div class="title-icon"><img src="/images/interview-icon.png"></div>
          <div class="title-h1">
            <h1>View/Edit Existing Record</h1>
          </div>
          ...
          <div class="form-group">
            <div class="col-sm-12">
              <a href="contact.php" class="btn btn-info btn-md btn-block" role="button">Contact Record Table</a> 
              <a href="status.php" class="btn btn-info btn-md btn-block" role="button">Interview Status Table</a>
              <a href="referral-form.php" class="btn btn-info btn-md btn-block" role="button">Referral Form</a>
              <a href="interview-demographics.php" class="btn btn-info btn-md btn-block" role="button">Demographics 1</a>
              <a href="interview-demographics-part2.php" class="btn btn-info btn-md btn-block" role="button">Demographics 2</a>
              <a href="locator.php" class="btn btn-info btn-md btn-block" role="button">Locator Form</a>
            </div>
          </div>
          <?php } else { ?>
